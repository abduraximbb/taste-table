...
let TableController = (() => {
    let _classDecorators = [(0, common_1.Controller)('table')];
    ...
    var TableController = _classThis = class {
        constructor(tableService) {
            this.tableService = (__runInitializers(this, _instanceExtraInitializers), tableService);
        }
    ...
    __setFunctionName(_classThis, "TableController");
    (() => {
        ...
        TableController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TableController = _classThis;
})();
