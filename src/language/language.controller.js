...
let LanguageController = (() => {
    let _classDecorators = [(0, common_1.Controller)('language')];
    ...
    var LanguageController = _classThis = class {
        constructor(languageService) {
            this.languageService = (__runInitializers(this, _instanceExtraInitializers), languageService);
        }
    ...
    __setFunctionName(_classThis, "LanguageController");
    (() => {
        ...
        LanguageController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LanguageController = _classThis;
})();
