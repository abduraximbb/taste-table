...
let ManagersController = (() => {
    let _classDecorators = [(0, common_1.Controller)('managers')];
    ...
    var ManagersController = _classThis = class {
        constructor(managersService) {
            this.managersService = (__runInitializers(this, _instanceExtraInitializers), managersService);
        }
    ...
    __setFunctionName(_classThis, "ManagersController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [(0, common_1.Post)()];
        _signIn_decorators = [(0, common_1.Post)('signin')];
        _signOut_decorators = [(0, common_1.Post)('signout')];
        _refreshToken_decorators = [(0, common_1.Post)('refreshtoken')];
        ...
        ManagersController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ManagersController = _classThis;
})();
