...
let MenuService = (() => {
    ...
    let _classThis;
    var MenuService = _classThis = class {
        constructor(menuModel, food_categoriesModel, restaurantModel) {
        ...
        create(createMenuDto) {
            ...
            if (!food_categories) {
                throw new common_1.BadRequestException("This food_categories not found");
            }
            if (!restaurant) {
