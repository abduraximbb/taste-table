...
let FoodCategoriesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('food-categories')];
    ...
    var FoodCategoriesController = _classThis = class {
        constructor(foodCategoriesService) {
            this.foodCategoriesService = (__runInitializers(this, _instanceExtraInitializers), foodCategoriesService);
        }
    ...
    __setFunctionName(_classThis, "FoodCategoriesController");
    (() => {
        ...
        FoodCategoriesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FoodCategoriesController = _classThis;
})();
